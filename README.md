...
[![Maven](https://img.shields.io/maven-central/v/io.taig.android/soap_2.11.svg)](http://search.maven.org/#artifactdetails%7Cio.taig.android%7Csoap_2.11%7C4.0.0-RC2%7Caar)
...
```scala
libraryDependencies += "io.taig.android" %% "soap" % "4.0.0-RC2"
```
