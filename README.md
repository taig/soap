...
[![Maven](https://img.shields.io/maven-central/v/io.taig.android/soap_2.11.svg)](http://search.maven.org/#artifactdetails%7Cio.taig.android%7Csoap_2.11%7C3.1.0-SNAPSHOT%7Caar)
...
````scala
libraryDependencies += "io.taig.android" %% "soap" % "3.1.0-SNAPSHOT"
````
